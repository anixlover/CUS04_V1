...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TUsuarioModalidadTanda>(entity =>
            {
                ...
                entity.Property(e => e.FkIcCodCat).HasColumnName("FK_IC_CodCat");
                ...
                entity.HasOne(d => d.FkIcCodCatNavigation)
                    .WithMany(p => p.TUsuarioModalidadTanda)
                    .HasForeignKey(d => d.FkIcCodCat)
                    .HasConstraintName("FK_T_Usuario_Modalidad_Tanda_T_Categoria");

                entity.HasOne(d => d.FkImIdModalidadNavigation)
                    .WithMany(p => p.TUsuarioModalidadTanda)
                    .HasForeignKey(d => d.FkImIdModalidad)
                    .HasConstraintName("FK_T_Usuario_Modalidad_Tanda_T_ModalidadCon");
